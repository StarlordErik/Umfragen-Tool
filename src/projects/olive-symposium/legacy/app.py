...
CONFIG_PATH = LEGACY_ROOT / "event_config.json"
DECRYPTION_PATH = LEGACY_ROOT / "decryption.json"
TEXTS_PATH = LEGACY_ROOT / "ui_texts.json"
STATIC_DIR = LEGACY_ROOT / "static"
...
OIL_SELECTION_PASSWORD = os.environ.get("OLIVE_ADMIN_PASSWORD", "")
...
def require_oil_password(value: Any) -> None:
    if not OIL_SELECTION_PASSWORD:
        raise ValueError("Admin-Zugang ist nicht konfiguriert.")
